      ...
      <div id="about">
        <div className="about-header">
          ...
          <p className="mx-4 text-muted about-text">
            ...
            and informal waste management systems and innovators to foster
            dynamic local and regional ecosystems for innovation. Waste Knot
            aims to inspire, empower and support young makers, innovators,
            entrepreneurs - create a continuously evolving ecosystem of
            innovation to boost circular economy.
          </p>
        </div>
              ...
              <div className="row">
                ...
                <div className="col-md-6 col-lg-6 col-12 about-text pt-5">
                  <p className="about-header">
                    ...
                    technologies to limit waste, preserve value and closing the
                    loop.
                  </p>
                  <ul className="mx-1 text-muted">
                    ...
                    <li className="p-2">
                      ...
                      start-ups with the connections, community, and capital
                      they can access at Catalyst.
                    </li>
                    <li className="p-2">
                      Apply insights and ideate bold solutions to tackle the
                      challenges we face at Circularity Hacks.
